...
#include "Sensor/MS5611Sensor.h" //ms5611
...
MS5611Sensor ms5611Sensor; //ms5611
    ...
    */
    ...
    if (firstTime) {
        ...
        if (moduleConfig.telemetry.environment_measurement_enabled) {
            LOG_INFO("Environment Telemetry: init sensors: RUN-ONCE");
            ...
            if (ms5611Sensor.hasSensor()) //ms5611
                result = ms5611Sensor.runOnce();
